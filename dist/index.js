...
var index = createUpdateEffect(react.useLayoutEffect);
...
function useCookieState(cookieKey) {
  ...
  function getCookieValue() {
    try {
      var cookieValue = Cookies__default['default'].get(cookieKey);
...
var useExternal = function useExternal(path, options) {
  var _useState = react.useState(path ? 'loading' : 'unset'),
      _useState2 = _slicedToArray(_useState, 2),
      status = _useState2[0],
...
exports.useCookieState = useCookieState;
