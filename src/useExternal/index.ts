...
const loadScript = (path: string, props: Options['js'] = {}): LoadResult => {
...
const loadCss = (path: string, props: Options['css'] = {}): LoadResult => {
...
const useExternal = (path?: string, options?: Options) => {
  ...
  useEffect(() => {
    ...
    const handler = (e: Event) => {
      ...
      ref.current?.setAttribute('dats-status', targetStatus);
